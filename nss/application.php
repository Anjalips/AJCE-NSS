...
<body>
<div id="bg"></div>
<form name="myform" action="application.php" onsubmit="return validateform()" method="post">


  <table  border="0" width="100%">
    <center><h1><u> APPLICATION  </u></h1></center>
    <tr>
      <td>Application Name</td>
      <td ><input type="text" name="aname" id="t1" /></td>
    </tr>
    <tr>
      <td>Place</td>
...
<?php
 ...
 $date=$_POST['date'];
     $time=$_POST['time'];
		...
		$sq="insert application (applicationname,appplace,appdate,apptime)values('$aname','$place','$date','$time')";
if(mysqli_query($co,$sq))
{
	
      echo "<script> alert('Success');
           window.location='application.php'</script>";
}
}

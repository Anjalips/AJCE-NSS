  ...
  <a href="login.php">LOGIN</a>
    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
			<div class="side-top">
				<div class="logo-sidebar">
					<a href="index.html"><img src="2jpg.jpg" alt="image"></a>
				</div>
				<ul class="sidebar-nav">
					
					<li><a href="sregg.php">Registration</a></li>
					<li><a href="viewactivity.php">Activity</a></li>
        ...
        <div id="page-content-wrapper">
            ...
            <div id="home" class="parallax first-section" data-stellar-background-ratio="0.4" style="background-image:url('nss.jpg');">
							...
							<div class="text-center item">
								<div class="col-md-8 col-md-offset-2 col-sm-12">
									<div class="big-tagline text-center">
										<h2><strong>AJCE NSS</strong><br>
										AMAL JYOTHI COLLEGE OF ENGINEERING</h2>
										<p class="lead"></p>
										<a href="sregg.php" class="btn btn-light btn-radius btn-brd grd1 effect-1 butn">REGISTER NOW</a>
									</div>
								</div>
							</div>
							<div class="text-center item">
            ...
            <section class="section nopad cac text-center">
                <a href="#"><h3>Interesting our awesome services? </h3></a>
            </section>
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 text-center">
                            <div class="message-box">
                                ...
                                <p class="lead">i. understand the community in which they work<br>
							...
							<div class="about-tab">
								...
								<div class="tab-content">
									<div class="tab-pane fade in active" id="tab_a">
										<p>The Motto of NSS "Not Me But You", reflects the essence of democratic living and upholds the need for self-less service. NSS helps the students development & appreciation to other person's point of view and also show consideration towards other living beings. The philosophy of the NSS is a good doctrine in this motto, which underlines on the belief that the welfare of an individual is ultimately dependent on the welfare of the society as a whole and therefore,
										the NSS volunteers shall strive for the well-being of the society.</p>
									</div>
									<div class="tab-pane fade" id="tab_b">
										<p>NSS contains the young population of the country, that is, the students studying in colleges and higher secondary schools.
										The young blood of these volunteers has a lot of passion. They want to do something for their country.</p>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                           <div class="service-widget">
                                <div class="post-media wow fadeIn">
                                    ...
                                    <img src="uploads/b4.jpg" alt="" class="img-responsive img-rounded">
                                </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="service-widget">
                                <div class="post-media wow fadeIn">
                                    ...
                                    <img src="uploads/b5.jpg" alt="" class="img-responsive img-rounded">
                                </div>
                                <h3>NSS Activities</h3>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="service-widget">
                                <div class="post-media wow fadeIn">
                                    ...
                                    <img src="uploads/b6.jpg" alt="" class="img-responsive img-rounded">
                                </div>
                                <h3>NSS Activities</h3>
...
<div id="barbers" class="section lb">
                    ...
                    <div class="row dev-list text-center">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                            <div class="widget clearfix">
								<div class="hover-br">
									<img src="uploads/b1.jpg" alt="" class="img-responsive">
                                ...
                                <div class="widget-title">
                                    <h3>Dr Z V Lakaparambil</h3>
                                    <small>The Principle</small>
                                </div>
                                <!-- end title -->
                                <p>His vibrant leadership, enduring vision and endearing interaction with 
								stakeholders enable Amal Jyothi blazing a trail of growth landmarks.</p>
                            </div><!--widget -->
                        </div><!-- end col -->
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
                            <div class="widget clearfix">
								<div class="hover-br">
									<img src="uploads/b2.jpg" alt="" class="img-responsive">
									<div class="social-up-hover">
										<div class="footer-social">
											<a href="#" class="btn grd1"><i class="fa fa-facebook"></i></a>
											<a href="#" class="btn grd1"><i class="fa fa-github"></i></a>
                                ...
                                <div class="widget-title">
                                    <h3>Ms.Gloria Mathew</h3>
                                    <small>The Program Officer</small>
                                </div>
                                <!-- end title -->
                                <p>i am Assistant Professor at Amal Jyothi College of Engineering and also nss program officer  </p>
                            </div><!--widget -->
                        </div><!-- end col -->
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.6s">
                            <div class="widget clearfix">
								<div class="hover-br">
									<img src="uploads/b3.jpg" alt="" class="img-responsive">
									<div class="social-up-hover">
										<div class="footer-social">
											<a href="#" class="btn grd1"><i class="fa fa-facebook"></i></a>
											<a href="#" class="btn grd1"><i class="fa fa-github"></i></a>
                                ...
                                <div class="widget-title">
                                    <h3>Devika m</h3>
                                    <small>The Volunteer Secreatary</small>
                                </div>
                                <!-- end title -->
                                <p>Hello guys, I am Devika. I am volunteer secreary of nss</p>
                            </div><!--widget -->
                        </div><!-- end col -->
                    </div><!-- end row -->
                </div><!-- end container -->
            ...
            <div id="testimonials" class="parallax section db parallax-off" style="background-image:url('a1.jpg');">
                <div class="container-fluid">
                    <div class="section-title row text-center">
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <div class="testi-carousel owl-carousel owl-theme">                                
                                <div class="testimonial clearfix">
                                    <div class="desc">
                                        ...
                                        <p class="lead">Well,There are many reasons why one should join NSS, I have been the volunteer in my college NSS unit and and its has been a fantastic experience since then with them.</p>
                                    </div>
                                    <div class="testi-meta">
                                        <img src="uploads/zv.jpg" alt="" class="img-responsive alignright">
                                        <h4>Dr Z V Lakaparambil <small>- Princilpe</small></h4>
                                    </div>
                                    <!-- end testi-meta -->
                                </div>
                                <!-- end testimonial -->
                                <div class="testimonial clearfix">
                                    ...
                                    <div class="testi-meta">
                                        <img src="uploads/gl.png" alt="" class="img-responsive alignright">
                                        <h4>Gloriya Mathew <small>- Program officer</small></h4>
                                    </div>
                                    <!-- end testi-meta -->
                                </div>
                                <!-- end testimonial -->
